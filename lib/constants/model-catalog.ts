...
export const FEATURE_CHECKLIST_ITEMS: Array<{ id: string; title: string; categories: ModelCategoryId[]; providers: Array<{ id: string; label: string }> }> = [
  { id: 'bake-start-frame', title: 'Bake Start Frame (Pass 1 + Pass 2)', categories: ['mask-inpaint', 'image-edit', 'multi-image-identity-edit'], providers: [{ id: 'replicate', label: 'Replicate' }, { id: 'fal', label: 'fal.ai' }, { id: 'xai', label: 'xAI' }] },
  { id: 'mannequin-pose-match', title: '3D mannequin pose matching', categories: ['pose-estimation'], providers: [{ id: 'fal', label: 'fal.ai' }, { id: 'replicate', label: 'Replicate' }] },
  { id: 'video-generation', title: 'Video generation from baked frame', categories: ['image-to-video', 'text-to-video', 'reference-to-video'], providers: [{ id: 'xai', label: 'xAI' }, { id: 'replicate', label: 'Replicate' }, { id: 'fal', label: 'fal.ai' }, { id: 'kling', label: 'Kling' }, { id: 'runway', label: 'Runway' }, { id: 'luma', label: 'Luma' }] },
  { id: 'motion-transfer-performance', title: 'Motion transfer performance', categories: ['motion-transfer'], providers: [{ id: 'viggle', label: 'Viggle' }, { id: 'kling', label: 'Kling' }, { id: 'fal', label: 'fal.ai' }] },
  { id: 'dialogue-audio', title: 'Dialogue audio path', categories: ['lip-sync', 'text-to-speech', 'voice-cloning'], providers: [{ id: 'kling', label: 'Kling' }, { id: 'replicate', label: 'Replicate' }, { id: 'fal', label: 'fal.ai' }, { id: 'openai', label: 'OpenAI' }, { id: 'xai', label: 'xAI' }] },
];

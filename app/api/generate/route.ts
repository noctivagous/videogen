...
export async function POST(request: Request) {
  try {
    const body = (await request.json()) as GenerationRequest & { streamProgress?: boolean };
    ...
    const run = (onProgress: NonNullable<GenerationRequest['onProgress']>) =>
      runGeneration({ ...body, apiKey, onProgress });
